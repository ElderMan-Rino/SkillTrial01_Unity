...
{
    internal sealed class UnityInputService : DisposableBase, IInputService, IGameSystem
    {
        ...
        private readonly IInputControlCenter _inputActions;

        public UnityInputService(IInputControlCenter inputActions)
        {
